...
colnames(battle.rate.mat.ww1.fronts.countries)[3:55] <- agg.battle.rate[which(agg.battle.rate[,1]=="Aug 1914"):
  which(agg.battle.rate[,1]=="Dec 1918"),1]
...
allies <- c("American", "Belgium", "British Empire", "France", "Italy", "Portugal", "Russian Empire", "Serbia", "Greece", "Romania")
